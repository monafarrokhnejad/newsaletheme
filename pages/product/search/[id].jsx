    ...
    return <NavbarLayout>
        <Box pt={2.5}>
            <Card sx={{
                ...
                <div>
                    <H5>جستجو برای "موبایل مثلا"</H5>
                    <Paragraph color="grey.600">تعداد محصولاتی که یافت شدند 48</Paragraph>
                </div>
                <FlexBox alignItems="center" flexWrap="wrap" my="0.5rem">
                    <FlexBox alignItems="center" flex="1 1 0">
                        ...
                        <TextField variant="outlined" size="small" placeholder="Short by" select
                                   defaultValue={sortOptions[0].value} fullWidth sx={{
                            flex: '1 1 0',
                            mr: '1.75rem',
                            minWidth: '150px'
                        }}>

      ...
      <WhiteLayout main={true}>
        ...
        <form className="content" onSubmit={handleSubmit}>
          <Box mt={3} mb={6}>
            ...
            <Divider />
            <Typography
              sx={{ margin: "1rem 0", fontSize: "13px", fontWeight: "bold" }}
              color={"primary"}
            >
              حاصل نوین قصد دارد در روز تولد اعضای خانواده شما، آنهارا شگفت زده
              کند. با پر کردن اطلاعات زیر مارا در این امر یاری کنید.
            </Typography>
            <Grid container spacing={2}>
            ...
            <Grid container spacing={2} justifyContent={"flex-end"}>
              <Grid item sm={3} xs={12}>
                <BazarButton
                  ...
                  type="submit"
                  fullWidth
                  sx={{ mt: "1.65rem", height: 44, color: "white" }}
                >
                  ثبت تغییرات
                </BazarButton>
              </Grid>

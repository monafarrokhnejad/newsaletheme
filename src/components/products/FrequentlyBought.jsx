...
const FrequentlyBought = ({productsData}) => {
    return <WrapperBox mb={7.5}>
        ...
        <FlexBox className="card-holder" flexWrap="wrap" m={-1}>
            {productsData.map((item, ind) =>
                <>
                    <Fragment key={item.id}>
                        ...
                        {ind < productsData.length - 1 && <FlexBox justifyContent="center" alignItems="center">
            ...
            <FlexBox className="gray-box" border="1px solid" borderColor="grey.400" m={1} borderRadius="8px"
                     justifyContent="center" alignItems="center" flexDirection="column" minWidth={300} minHeight={200}>
                ...
                <FlexBox>
                    <BazarButton variant="contained" color="primary" sx={{
                        mr: "1rem"
                    }}>
                        Add to Cart
                    </BazarButton>
